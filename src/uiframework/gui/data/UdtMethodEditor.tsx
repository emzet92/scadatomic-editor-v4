...
export function UdtMethodEditor({ data, udtId, methodId }: { data: ProjectData; udtId: string; methodId: string }) {
  ...
  if (!definition || !method) return <Box className="p-8 text-sm text-[var(--editor-text-muted)]">UDT method no longer exists.</Box>;
  ...
  return <Box className="mx-auto max-w-6xl space-y-5 p-8">
